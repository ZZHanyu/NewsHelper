...
parser.add_argument("--chunk_size", type=int, default=25, help="control how many lines read once / single batch size")
parser.add_argument("--max_epochs", type=int, default=50, help="epochs of training")
parser.add_argument("--test_batch", type=int, default=10, help="how many batch dataset used for testing")
